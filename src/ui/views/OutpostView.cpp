...
void OutpostView::draw()
{
  ...
  Fonts::drawString(i18n::s(GfxData::raceGfxSpec(city->race).name), FontFaces::Small::YELLOW, 35, 72, ALIGN_LEFT);
  
  auto& houseSpec = GfxData::raceHouseGfxSpec(GfxData::raceGfxSpec(city->race).houseType);
