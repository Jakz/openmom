...
NewGameView::NewGameView(ViewManager * gvm) : View(gvm)
{
  ...
  buttons[OPTIONS_DIFFICULTY] = new LabeledSimpleButton("Difficulty", 251, 39, SpriteInfo(NEW_GAME_BUTTONS1, 0, 2), "", BROWN_MEDIUM_BOLD_SHADOW);
  buttons[OPTIONS_OPPONENTS] = new LabeledSimpleButton("Opponents", 251, 66, SpriteInfo(NEW_GAME_BUTTONS1, 0, 3), "", BROWN_MEDIUM_BOLD_SHADOW);
  buttons[OPTIONS_LAND_SIZE] = new LabeledSimpleButton("Land Size", 251, 93, SpriteInfo(NEW_GAME_BUTTONS1, 0, 4), "", BROWN_MEDIUM_BOLD_SHADOW);
  buttons[OPTIONS_MAGIC] = new LabeledSimpleButton("Magic", 251, 120, SpriteInfo(NEW_GAME_BUTTONS1, 0, 5), "", BROWN_MEDIUM_BOLD_SHADOW);
