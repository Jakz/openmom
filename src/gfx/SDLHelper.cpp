...
bool SDL::init()
{
  ...
  window = SDL_CreateWindow("OpenMoM v0.01a", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, WIDTH*SCALE_FACTOR, USE_ORIGINAL_ASPECT_RATIO ? 240*SCALE_FACTOR : HEIGHT*SCALE_FACTOR, SDL_WINDOW_OPENGL|SDL_WINDOW_ALLOW_HIGHDPI);
