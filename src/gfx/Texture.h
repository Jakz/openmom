...
enum TextureID : u16
{
  ...
  TEXTURE_FONT_TINY,
  TEXTURE_FONT_TINY_COMPACT,
  TEXTURE_FONT_TINY_COMPACT_CRYPT,
  TEXTURE_FONT_SERIF_CRYPT,
  TEXTURE_FONT_YELLOW_SMALL,
  TEXTURE_FONT_SERIF,
  TEXTURE_FONT_TEAL_MEDIUM,
  TEXTURE_FONT_MEDIUM_BOLD,
  TEXTURE_FONT_HUGE_SERIF,
