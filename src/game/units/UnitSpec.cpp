...
static const RaceUnitSpec raceSpecs[] = {
  RaceUnitSpec(  UnitID::SPEARMEN, RaceID::BARBARIANS, 0,  15,     1, 0,   Ranged::NONE, 0,    2, 5, 1, 8,    1, 1,   {}), // LARGE_SHIELD
  ...
  RaceUnitSpec(  UnitID::SETTLERS, RaceID::BARBARIANS, 2,  50,     0, 0,   Ranged::NONE, 0,    1, 5,10, 1,    1, 1,   {}), // CREATE_OUTPOST
...
static const HeroSpec heroSpecs[] = {
  HeroSpec(UnitID::HERO_DWARF, HeroType::HERO, ItemSlots::WARRIOR, 2, -1,    5, 0, Ranged::NONE, 0,     4, 10, 11, 1,    1, 1,   {}), // LUCK, MOUNTAINWALK
  HeroSpec(UnitID::HERO_ORC_WARRIOR, HeroType::HERO, ItemSlots::WARRIOR, 2, -1,   6, 0, Ranged::NONE, 0,    4, 6, 8, 1,    1, 1,   {}) // MOUNTAINWALK
};

static const SummonSpec summonSpecs[] = {
  SummonSpec(UnitID::MAGIC_SPIRIT, 1, 30,    5, 0, Ranged::NONE, 0,    4, 8, 10, 1,     1, 2,   {}), // MELD NON_CORPOREAL
